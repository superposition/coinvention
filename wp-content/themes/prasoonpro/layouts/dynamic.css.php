<?php
/**
 * Prasoonpro: Dynamic CSS Stylesheet
 * 
 */

function prasoonpro_dynamic_css_stylesheet() { 
    ...
    $trans_buttonhover_bg_color= sanitize_hex_color(get_theme_mod( 'trans_buttonhover_bg_color','#dd3333' ));
    ...
    $cf7_btn_bg_color= sanitize_hex_color(get_theme_mod( 'cf7_btn_bg_color','#dd3333' ));
    ...
    $dd_menu_bg_hover_color= sanitize_hex_color(get_theme_mod( 'dd_menu_bg_hover_color','#dd3333' ));
...
return apply_filters( 'prasoonpro_dynamic_css_stylesheet', $css);
