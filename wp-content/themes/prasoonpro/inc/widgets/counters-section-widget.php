...
class Prasoon_Counters_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Counters Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Counters section. Section id : counters', 'prasoonpro' ), ) // Args
		);
	}
    ...
    ?>
        ...
        <p>
	        <label for="<?php echo $this->get_field_id('name1'); ?>"><?php _e('Name 1:','prasoonpro'); ?></label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id('value1'); ?>"><?php _e('Value 1:','prasoonpro'); ?></label>
	    ...
	    <p>
	        <label for="<?php echo $this->get_field_id('name2'); ?>"><?php _e('Name 2:','prasoonpro'); ?></label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id('value2'); ?>"><?php _e('Value 2:','prasoonpro'); ?></label>
	    ...
	    <p>
	        <label for="<?php echo $this->get_field_id('name3'); ?>"><?php _e('Name 3:','prasoonpro'); ?></label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id('value3'); ?>"><?php _e('Value 3:','prasoonpro'); ?></label>
	    ...
	    <p>
	        <label for="<?php echo $this->get_field_id('name4'); ?>"><?php _e('Name 4:','prasoonpro'); ?></label>
		...
		<p>
	        <label for="<?php echo $this->get_field_id('value4'); ?>"><?php _e('Value 4:','prasoonpro'); ?></label>
