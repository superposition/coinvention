...
class Prasoon_Features_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Features Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Features section. Section id : features', 'prasoonpro' ), ) // Args
		);
    ...
    <section id="features" style="background:<?php echo $color; ?>;color:<?php echo $contentcolor; ?>;">
                                ...
                                for( $i=1; $i<4; $i++ ) { 
                                    ...
                                    <?php if(!empty($fheading)){
                                        ...
                                        <div class="content-block wow slideInLeft" data-wow-duration="2s" data-wow-delay="<?php echo $i/3; ?>s">
                                            <span class="badge" style="background:<?php echo $iconbgcolor; ?>"><label style="color:<?php echo $iconcolor; ?>"><?php echo $i ;?></label></span>
    ...
    <div>
        <label for="<?php echo $this->get_field_id( 'image' ); ?>"><?php _e('Center Image URL', 'prasoonpro'); ?>:</label>
    ...
    <br/>
    <label><strong><?php _e('Features list:','prasoonpro'); ?></strong></label><br/>
    ...
    <div class="widget-block">
        <?php for( $i = 1; $i < 7; $i++ ) { 
            ...
            <div class="widget-block-box">
                <div class="widget-block-head"><a href="#"><?php _e('Feature', 'prasoonpro');echo $i; ?></a><span class="widget-plus">+</span><span class="widget-minus">-</span></div>
                <div class="widget-block-content">                    
                    <p>
                        <label for="<?php echo $this->get_field_id('fheading'.$i); ?>"><?php _e('Heading','prasoonpro');echo $i; ?></label>
                        ...
                        <label for="<?php echo $this->get_field_id('fsubheading'.$i); ?>"><?php _e('Subheading','prasoonpro');echo $i; ?></label>
    ...
    <div class="widget-block">        
        <div class="widget-block-box">
            ...
            <div class="widget-block-content">
                ...
                <h3><?php _e('Small Heading Color:','prasoonpro'); ?></h3>
                <p>
