...
class Prasoon_Contact_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Contact Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Contact section. Section id : contact', 'prasoonpro' ), ) // Args
		);
    ...
    <p>
        <label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address','prasoonpro'); ?></label>
		...
		<p>
        <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email:','prasoonpro'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('email'); ?>" name="<?php echo $this->get_field_name('email'); ?>" type="text" value="<?php echo $email; ?>" />
    </p>

    <p>
        <label for="<?php echo $this->get_field_id('phone'); ?>"><?php _e('Phone:','prasoonpro'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('phone'); ?>" name="<?php echo $this->get_field_name('phone'); ?>" type="text" value="<?php echo $phone; ?>" />
    </p>

    <p>
        <label for="<?php echo $this->get_field_id('contactform'); ?>"><?php _e('Contact Form Shortcode:','prasoonpro'); ?></label>
    ...
    <h3><?php _e('Social Icons:','prasoonpro'); ?></h3>

    <p>
        <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of Social Icons:','prasoonpro'); ?></label>
    ...
    <div class="widget-block">
        <?php for( $i = 1; $i <= $number; $i++ ) { 
            ...
            <div class="widget-block-box">
                <div class="widget-block-head"><a href="#"><?php _e('Icon', 'prasoonpro');echo $i; ?></a><span class="widget-plus">+</span><span class="widget-minus">-</span></div>
                <div class="widget-block-content">
                    <div>
                        <p>
                            <label for="<?php echo $this->get_field_id('icon'.$i); ?>"><?php _e('FontAwesome Icon (eg fa-facebook):','prasoonpro'); ?></label>
                        ...
                        <p>
                            <label for="<?php echo $this->get_field_id('iconurl'.$i); ?>"><?php _e('Icon URL:','prasoonpro'); ?></label>
    ...
    <div class="widget-block">        
        <div class="widget-block-box">
            ...
            <div class="widget-block-content">
                ...
                <p><?php _e('Note: Social icons colors can be set from main Color Settings','prasoonpro'); ?></p>
