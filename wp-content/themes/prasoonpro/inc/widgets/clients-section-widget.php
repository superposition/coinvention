...
class Prasoon_Clients_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Clients Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Clients section. Section id : clients', 'prasoonpro' ), ) // Args
		);
    ...
    <br/>
    <label><strong><?php _e('Add Clients:','prasoonpro'); ?></strong></label><br/>
    <p>
        <label for="<?php echo $this->get_field_id('nop'); ?>"><?php _e('Number of Clients:','prasoonpro'); ?></label>
            ...
            for( $i = 1; $i <= $number; $i++ ) {
                ...
                ?>
                    <div class="widget-block-box">
                        <div class="widget-block-head"><a href="#"><?php _e('Client', 'prasoonpro');echo $i; ?></a><span class="widget-plus">+</span><span class="widget-minus">-</span></div>
