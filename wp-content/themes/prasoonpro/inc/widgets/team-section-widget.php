...
class Prasoon_Team_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Team Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Team section. Section id : team', 'prasoonpro' ), ) // Args
		);
    ...
    <section id="team" style="background:<?php echo $color; ?>;color:<?php echo $contentcolor; ?>;">
    ...
    <br/>
    <label><strong><?php _e('Add Team Members:','prasoonpro'); ?></strong></label><br/>

    <p>
        <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of Team Members:','prasoonpro'); ?></label>
    ...
    <div class="widget-block">
        <?php for( $i = 1; $i <= $number; $i++ ) { 
            ...
            <div class="widget-block-box">
                <div class="widget-block-head"><a href="#"><?php _e('Team Member', 'prasoonpro');echo $i; ?></a><span class="widget-plus">+</span><span class="widget-minus">-</span></div>
                <div class="widget-block-content">  
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('name'.$i); ?>"><?php _e('Name','prasoonpro'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('desg'.$i); ?>"><?php _e('Designation','prasoonpro'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('descr'.$i); ?>"><?php _e('Small Description','prasoonpro'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('icon1'.$i); ?>"><?php _e( 'Font-Awesome Icon1 (for eg: fa-facebook)', 'prasoonpro' ); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('icon1url'.$i); ?>"><?php _e( 'Icon1 Url', 'prasoonpro' ); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('icon2'.$i); ?>"><?php _e( 'Font-Awesome Icon2 (for eg: fa-twitter)', 'prasoonpro' ); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('icon2url'.$i); ?>"><?php _e( 'Icon2 Url', 'prasoonpro' ); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('icon3'.$i); ?>"><?php _e( 'Font-Awesome Icon3 (for eg: fa-google-plus)', 'prasoonpro' ); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('icon3url'.$i); ?>"><?php _e( 'Icon3 Url', 'prasoonpro' ); ?></label>
    ...
    <div class="widget-block">        
        <div class="widget-block-box">
            <div class="widget-block-head"><a href="#"><?php _e('Color Settings','prasoonpro'); ?> </a><span class="widget-plus">+</span><span class="widget-minus">-</span></div>
            <div class="widget-block-content">
