...
class Prasoon_Services_Style2_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Services 4 Column Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Services 4 Column section. Section id : services-1', 'prasoonpro' ), ) // Args
		);
    ...
    <section id="services-1" style="background:<?php echo $color; ?>;color:<?php echo $contentcolor; ?>">
