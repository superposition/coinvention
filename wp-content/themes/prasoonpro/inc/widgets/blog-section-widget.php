...
class Prasoon_Blog_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Blog Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Blog section. Section id : blog', 'prasoonpro' ), ) // Args
		);
    ...
    if ( $query->have_posts() ) { ?>
      <section id="blog" style="background:<?php echo $color; ?>;color:<?php echo $contentcolor; ?>;">
                    ...
                    <div class="col-md-4 col-sm-6">
                      <div class="blog-wrap wow fadeInUp" data-wow-duration="2s" data-wow-delay="1.5s">
                        ...
                        <div class="meta">
                          ...
                          <span class="comments"><i class="fa fa-comments"></i><?php comments_number('0','1','%'); ?>  <?php _e('Comments','prasoonpro'); ?></span>                          
                        ...
                        <div class="blog-content">
                          <p><?php the_excerpt(); ?></p>
                          <a class="read-more" href="<?php the_permalink() ?>"><?php _e('READ MORE ','prasoonpro'); ?><i class="fa fa-plus-circle"></i></a>
                        </div>
                      </div>
                    </div>
					<?php
    ...
    <div class="widget-block">        
        <div class="widget-block-box">
            ...
            <div class="widget-block-content">
                ...
                <p><?php _e('Note: Blog title and Category color can be set from main Color Settings','prasoonpro'); ?></p>
