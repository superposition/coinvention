...
class Prasoon_Portfolio_Section_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __( 'Prasoon: Portfolio Section', 'prasoonpro' ), // Name
            array( 'description' => __( 'Adds Portfolio section. Section id : portfolio', 'prasoonpro' ), ) // Args
        );
                        ...
                        <ul id="filter" class="option-set clearfix">
                            <?php
                                if(! empty( $instance['prjcat1'])){
                                    ?><li data-filter="*" class="selected"><a href="#"><?php _e('ALL','prasoonpro'); ?></a></li><?php
                                }
                            ?>                            
                            <?php
                                $cat=array();
                                            ...
                                            <li class="list_item col-lg-3 col-md-3 col-sm-3 col-xs-12 <?php echo $prjcat; ?>">
                                                <div class="hovereffect" style="background:<?php echo $hovercolor; ?>;">                                                    
                                                    ...
                                                    <div class="overlay">
                                                        ...
                                                        <p><a title="<?php echo $prjheading; ?> <small><?php echo $prjdescr; ?></small>" class="image-popup-link" href="<?php echo esc_url($image); ?>"><?php _e('VIEW','prasoonpro'); ?></a></p>
                                                    </div>
                                                </div>                                                
                                            </li>    
                                        <?php
    ...
    <br/>
    <label><strong><?php _e('Add Portfolio:','prasoonpro'); ?></strong></label><br/>

    <p>
        <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of Portfolio Items:','prasoonpro'); ?></label>
    ...
    <div class="widget-block">
        <?php for( $i = 1; $i <= $number; $i++ ) { 
            ...
            <div class="widget-block-box">
                <div class="widget-block-head"><a href="#"><?php _e('Portfolio Item', 'prasoonpro');echo $i; ?></a><span class="widget-plus">+</span><span class="widget-minus">-</span></div>
                <div class="widget-block-content">  

                    <div>
                        <label for="<?php echo $this->get_field_id( 'imagethumb'.$i ); ?>"><?php _e('Image Thumb (300px X 200px)', 'prasoonpro'); ?>:</label>
                    ...
                    <div>
                        <label for="<?php echo $this->get_field_id( 'image'.$i ); ?>"><?php _e('Image', 'prasoonpro'); ?>:</label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('prjheading'.$i); ?>"><?php _e('Project Heading','prasoonpro'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('prjdescr'.$i); ?>"><?php _e('Project Description','prasoonpro'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('prjcat'.$i); ?>"><?php _e('Project Category','prasoonpro'); ?></label>
    ...
    <div class="widget-block">        
        <div class="widget-block-box">
            ...
            <div class="widget-block-content">
                ...
                <h3><?php _e('Image Hover Color:','prasoonpro'); ?></h3>
                <p>
