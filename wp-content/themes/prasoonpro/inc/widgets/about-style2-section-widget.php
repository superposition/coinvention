...
class Prasoon_About_Style2_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: About Style 2 Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds about style2 section. Section id : about-1', 'prasoonpro' ), ) // Args
		);
    ...
    <!-- Begin About Section -->
    <section id="about-1" style="background:<?php echo $color; ?>;color:<?php echo $contentcolor; ?>;">
    ...
    <section id="content-style1" style="background:<?php echo $color; ?>;color:<?php echo $contentcolor; ?>;">
    ...
    <p>
        <label for="<?php echo $this->get_field_id('content'); ?>"><?php _e('About Content','prasoonpro'); ?></label>
    ...
    <h3><?php _e('Left Image and Skills Section:','prasoonpro'); ?></h3><br/>
    <div>
        <label for="<?php echo $this->get_field_id( 'image' ); ?>"><?php _e('Image URL', 'prasoonpro'); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('skillsheading'); ?>"><?php _e('Skill Section Heading:','prasoonpro'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of Skills:','prasoonpro'); ?></label>
            ...
            for( $i = 1; $i <= $number; $i++ ) {    
                ...
                ?>
                    <div class="widget-block-box">
                        <div class="widget-block-head"><a href="#"><?php _e('Skill', 'prasoonpro');echo $i; ?></a><span class="widget-plus">+</span><span class="widget-minus">-</span></div>
                        <div class="widget-block-content">
                            <p>
                                <label for="<?php echo $this->get_field_id('skillname'.$i); ?>"><?php _e('Skill Name','prasoonpro');echo $i; ?></label>
                                ...
                                <label for="<?php echo $this->get_field_id('skillvalue'.$i); ?>"><?php _e('Skill Value','prasoonpro'); echo $i.' Without %'; ?></label>
    ...
    <div class="widget-block">        
        <div class="widget-block-box">
            ...
            <div class="widget-block-content">
                ...
                <h3><?php _e('Skill Bar color:','prasoonpro'); ?></h3>
                <p>
