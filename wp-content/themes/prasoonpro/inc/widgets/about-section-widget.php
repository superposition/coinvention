...
class Prasoon_About_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: About Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds about section. Section id : about', 'prasoonpro' ),) // Args
		);
    ...
    <section id="about" style="background:<?php echo $color; ?>;color:<?php echo $contentcolor; ?>;">
                    ...
                    <div class="row">
                        <div class="content">
                            <div class="col-md-5 col-sm-12 col-xs-12 wow slideInLeft" data-wow-duration="2s" data-wow-delay="1.5s">
                                ...
                                <?php 
                                    if(!empty($buttontext)):
                                        ?><a href="<?php echo esc_url($buttonurl); ?>"><button style="background:<?php echo $btncolor; ?>;color:<?php echo $btntextcolor; ?>;border:0;" type="button" class="btn btn-default black"><?php echo $buttontext; ?> <i class="fa fa-angle-double-right"></i></button></a><?php 
                                    endif 
                                ?>
                            </div>
	...
	<p>
        <label for="<?php echo $this->get_field_id('buttontext'); ?>"><?php _e('Button Text:','prasoonpro'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('buttonurl'); ?>"><?php _e('Button URL:','prasoonpro'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_desc'); ?>"><?php _e('Image Description','prasoonpro'); ?></label>
    ...
    <div class="widget-block">        
        <div class="widget-block-box">
            ...
            <div class="widget-block-content">
                ...
                <h3><?php _e('Button Background Color:','prasoonpro'); ?></h3>
                <p>
