...
class Prasoon_CTA_Section_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Call to Action Section', 'prasoonpro' ), // Name
			array( 'description' => __( 'Adds Call to Action section. Section id : cta', 'prasoonpro' ), ) // Args
		);	
    ...
    ?>  
	    ...
	    <p>
            <label for="<?php echo $this->get_field_id( 'button_text'); ?>"><?php _e( 'Button Text', 'prasoonpro' ); ?>:</label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'button_url' ); ?>"><?php _e( 'Button Url', 'prasoonpro' ); ?>:</label>
