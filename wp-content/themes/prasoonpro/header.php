            			...
            			<div class="col-md-3 col-sm-4">
              				<div class="navbar-header">
                				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                  					<span class="sr-only"><?php _e( 'Toggle navigation', 'prasoonpro' ); ?></span>
			        		...
			        		?>		       
			          			<div class="promo-section wow fadeInUp" data-wow-duration="2s" data-wow-delay="1s">
			            			<div class="container">
			              				<div class="row">
			                				<div class="col-md-12">
			                  					<h2><?php echo esc_attr(get_theme_mod( 'home_heading_text', __('WRITE YOUR HEADING HERE','prasoonpro')));?></h2>
			                  					<p><?php echo esc_attr(get_theme_mod( 'home_subheading_text', __('change this to your subheading. You can change this in the customizer General Settings section','prasoonpro')));?></p>
