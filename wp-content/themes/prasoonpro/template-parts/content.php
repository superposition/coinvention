				...
				<div class="content">
					<?php
						...
						<?php
							...
							wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'prasoonpro' ), array( 'span' => array( 'class' => array() ) ) ),
							the_title( '<span class="screen-reader-text">"', '"</span>', false )
							) );
						?>

						<div class="read-more">
							<a href="<?php echo esc_url( get_permalink() ); ?>"><?php _e('READ MORE','prasoonpro'); ?></a>
						</div>
		...
		<div class="col-md-4 col-sm-6">
			<div class="blog-wrap wow fadeInUp" data-wow-duration="2s" data-wow-delay="1.5s">
				...
				<div class="meta">
					...
					<span class="comments blogstyle"><i class="fa fa-comments"></i><?php comments_number('0','1','%'); ?>  <?php _e('Comments','prasoonpro'); ?></span>                          
