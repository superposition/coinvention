 ...
 *  Set Import files
 */
function prasoonpro_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Demo content', 'prasoonpro'),
...
add_filter( 'pt-ocdi/import_files', 'prasoonpro_set_import_files' );

/**
 * Actions after import
 */
function prasoonpro_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'prasoonpro_after_import_setup' );