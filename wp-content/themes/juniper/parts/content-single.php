    ...
    <div <?php post_class('content row'); ?>>
        <div class="col-xs-12 content-column">
            <div class="row single_meta">
                ...
                <div class="col-sm-4">
                    <?php if (comments_open()) { ?><p class="text-right"><a href="<?php the_permalink(); ?>#comments" ><?php comments_number( __('No comments', 'juniper'), __('One comment', 'juniper'), __('% comments', 'juniper') ); ?></a></p><?php } ?>
                </div>
            </div>
            <?php
            the_content();
