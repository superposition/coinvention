		...
		class gdlr_core_pb_element_blockquote{
			...
			static function get_content( $settings = array() ){
				...
				if( !empty($settings['author']) ){
					$ret .= '<div class="gdlr-core-blockquote-item-author gdlr-core-skin-caption">';
					$ret .= gdlr_core_text_filter($settings['author']);
					if( !empty($settings['author-position']) ){
						$ret .= '<span class="gdlr-core-blockquote-item-author-position" >' . gdlr_core_text_filter($settings['author-position']) . '</span>';
					}
					$ret .= '</div>';
				}
				$ret .= '</div>';
