					...
					'general' => array(
						...
						'options' => array(
							...
							'filterer' => array(
								...
								'description' => esc_html__('Filter is not supported and will be automatically disabled on carousel layout.', 'goodlayers-core'),
							),
					...
					'shadow' => array(
						...
						'options' => array(
							'frame-shadow-size' => array(
								'title' => esc_html__('Frame Shadow Size ( Only for frame style )', 'goodlayers-core'),
								'type' => 'custom',
								'item-type' => 'padding',
							...
							'frame-shadow-color' => array(
								'title' => esc_html__('Frame Shadow Color ( Only for frame style )', 'goodlayers-core'),
								'type' => 'colorpicker'
							),
							'frame-shadow-opacity' => array(
								'title' => esc_html__('Frame Shadow Opacity ( Only for frame style )', 'goodlayers-core'),
								'type' => 'text',
								'default' => '0.2',
...
jQuery(document).ready(function(){
	jQuery('#gdlr-core-preview-blog-<?php echo esc_attr($id); ?>').parent().gdlr_core_flexslider().gdlr_core_isotope().gdlr_core_content_script();
			...
			static function get_content( $settings = array() ){
				...
				if( !is_array($settings['meta-option']) ){
