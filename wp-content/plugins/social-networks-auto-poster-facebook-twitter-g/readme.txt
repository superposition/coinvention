...
Wordpress 3.4+ (4.8+ is preffered)
PHP 5.3+ (7+ is preffered)
cURL
Correctly working WP cron is requred for some functionality (Shedulled posts, Auto reposter, Comments Import, etc...)
